        ...
        <section className="container mx-auto px-4 py-32">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div>
              ...
              <Link href={"https://www.instagram.com/janewylderrr"} 
              target="_blank" 
              ...
              <Link href={"https://www.tiktok.com/@janewylderrr"} target="_blank" rel="noopener noreferrer" className="bg-pink-300 rounded-2xl">
                <Button variant={"outline"} className={"flex items-center gap-2 bg-pink-300"}>
                  <Image
              ...
              <div className="flex justify-center h-full w-full gap-3 py-10">
              <Link href={"https://onlyfans.com/janewylderr"} target="_blank" rel="noopener noreferrer" className="bg-pink-300 rounded-2xl">
